...
<body>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $v['dateOfManufacture']; ?></td>
                <td><?php echo $v['placeOfManufacture']; ?></td>
                <td><?php echo $v['deliveryDate']; ?></td>
                <td><?php echo $v['mileageAtDelivery']; ?></td>
    ...
    <button onclick="window.location.href='pricesticker.php'">Back to Simple View</button>
</body>
</html>